...
class Player {
  constructor(game) {
    ...
    this.lives = 3;
    this.maxLives = 10;
    this.image = document.getElementById("player-game");
    this.jets_image = document.getElementById("player_jets-game");
    this.frameX = 0;
    this.jetsFrame = 1;
...
class Beetlemorph extends Enemy {
  constructor(game, positionX, positionY) {
    ...
    this.image = document.getElementById("beetlemorph-game");
    this.frameX = 0;
    this.maxFrame = 2;
...
class Rhinomorph extends Enemy {
  constructor(game, positionX, positionY) {
    super(game, positionX, positionY);
    this.image = document.getElementById("rhinomorph_game");
    this.frameX = 0;
    this.maxFrame = 5;
    this.frameY = Math.floor(Math.random() * 4);
    this.lives = 4;
...
class Boss {
  constructor(game, bossLives) {
    ...
    this.maxLives = this.lives;
    this.image = document.getElementById("boss-game");
    this.frameX = 1;
    this.frameY = Math.floor(Math.random() * 4);
    this.maxFrame = 11;
  }
